...
public class BreakGlass : MonoBehaviour {
	...
	*/
	public void BreakIt(){
		...
		if(BreakSound) AudioManager.instance.PlayBrokenGlass(transform.position);// Destroy(Instantiate(SoundEmitter, transform.position, transform.rotation) as GameObject, SoundEmitterLifetime);
