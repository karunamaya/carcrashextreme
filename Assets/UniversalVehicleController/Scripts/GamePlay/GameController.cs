...
namespace PG
{
    ...
    public class GameController :Singleton<GameController>
    {
        ...
        public static bool SplitScreen => Instance && Instance.m_SplitScreen;
        ...
        public List<CarController> myCars;
        ...
        void Start ()
        {
          ...
          GameObject[] am;
          am = GameObject.FindGameObjectsWithTag("levelMusic");
          
          if(am.Length ==0)
Instantiate(levelMusic, new Vector3(0, 0, 0), Quaternion.identity);
          
            switch (PlayerPrefs.GetInt("carNumber"))
            {
                case 1:
                    myCars[0].SetActive(true);
                    AllCars[0] = myCars[0];
                    break;
                case 2:
                    myCars[1].SetActive(true);
                    AllCars[0] = myCars[1];
                    break;
                case 3:
                    myCars[2].SetActive(true);
                    AllCars[0] = myCars[2];
                    break;
                case 4:
                    myCars[3].SetActive(true);
                    AllCars[0] = myCars[3];
                    break;
                case 5:
                    myCars[4].SetActive(true);
                    AllCars[0] = myCars[4];
                    break;
        ...
        public void SetNextCar ()
        {
            if (PlayerCar1)
            {
                var studioListiner = PlayerCar1.GetComponent<FMODUnity.StudioListener> ();
        ...
        InitializePlayer UpdateSelectedCar (InitializePlayer player, CarController car)
        {
            ...
            var studioListiner = car.GetComponent<FMODUnity.StudioListener> ();

            if (!studioListiner)
            {
                studioListiner = car.gameObject.AddComponent<FMODUnity.StudioListener> ();
            }
        ...
        void ChangeTimeScale (float delta)
        {
            ...
            fmodTimescaleGroup.setPitch (Time.timeScale);
        }
    }
}
